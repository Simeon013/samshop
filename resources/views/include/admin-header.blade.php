            ...
            <ul class="menu-inner py-1">
              ...
              <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  ...
                  <div data-i18n="Creation">Création</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  <i class="menu-icon tf-icons bx bx-layout"></i>
                  <div data-i18n="Affichage">Affichage</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item">
              ...
              <li class="menu-item">
                <a href="javascript:void(0)" class="menu-link menu-toggle">
                  ...
                  <div data-i18n="User interface">Utilisateurs</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item">
              ...
              <li class="menu-item">
                ...
                >
                  ...
                  <div data-i18n="Documentation">Paramettres</div>
                </a>
              </li>
              <li class="menu-item">
                <a
