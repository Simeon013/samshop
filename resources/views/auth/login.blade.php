...
>
  <head>
    ...
    <title>BYA Trends - Login</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('all/favicon.png')}}" />
            ...
            <div class="card">
              ...
              <div class="app-brand justify-content-center m-0">
                <a href="{{route('home')}}" class="app-brand-link gap-2">
                  ...
                  {{-- <span class="app-brand-text text-body fw-bolder">BYA Trends</span> --}}
                </a>
              </div>
              <!-- /Logo -->
                <h4 class="mb-2">Bienvenue sur BYA Trends! 👋</h4>
                <p class="mb-4">Veuillez-vous connecter pour commencer l'aventure </p>
