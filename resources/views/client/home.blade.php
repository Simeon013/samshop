		...
		<div class="wrap-slick1">
			<div class="slick1">
				@foreach ($sliders as $slider)
                    <div class="item-slick1" style="background-image: url(/storage/slider_images/{{$slider->slider_image}});;">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$product->category->category_name}}">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                ...
                                <a href="/ajouter_au_panier/{{$product->id}}" class="block2-btn flex-c-m stext-100 cl2 size-102 bg0 bor2 hov-btn1 trans-04">
                                    Ajouter au panier
                                </a>
                            </div>
